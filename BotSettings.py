...
queue_command_arguments_sep = "[[sep]]" # The seperator between arguments inside a string because spaces could be insufficient. Use the same seperator as in the game's code (code/modules/discord_persistence/_hook.dm)
